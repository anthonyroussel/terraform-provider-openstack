		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"openstack_workflow_cron_trigger_v2.cron_trigger_1", "remaining_executions", "3"),
					resource.TestCheckResourceAttrSet(
						"openstack_workflow_cron_trigger_v2.cron_trigger_1", "first_execution_time"),
					resource.TestCheckResourceAttrSet(
...
func testAccWorkflowV2CronTriggerBasic(workflowID string, firstExecutionTime string) string {
	return fmt.Sprintf(`
