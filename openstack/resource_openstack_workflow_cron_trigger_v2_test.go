...
func TestAccWorkflowV2CronTrigger_basic(t *testing.T) {
	...
	if os.Getenv("TF_ACC") != "" {
		...
		defer testAccWorkflowV2WorkflowDelete(t, workflow.ID) //nolint:errcheck
	}
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"openstack_workflow_cron_trigger_v2.cron_trigger_1", "workflow_name", workflowName),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"openstack_workflow_cron_trigger_v2.cron_trigger_1", "workflow_params.%", "1"),
					resource.TestCheckResourceAttr(
						"openstack_workflow_cron_trigger_v2.cron_trigger_1", "remaining_executions", "2"),
					resource.TestCheckResourceAttrSet(
